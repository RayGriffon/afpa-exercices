...
{
    /**
     * Ce contrôlleur affiche toutes les recettes
     *
    ...
    /**
     * Ce controlleur permet de créer un nouvelle recette
     *
     * @param Request $request
    ...
    public function delete(EntityManagerInterface $manager, Recipe $recipe) : Response
    {
        ...
        $this->addFlash('warning', 'Votre recette a été supprimé avec succès !');
